...
#define SWIG_V8_VERSION 0x03145
#endif
...
#define SWIGTYPE_p_uint8Array swig_types[22]
...
#define SWIGTYPE_p_uv_work_t swig_types[27]
#define SWIGTYPE_p_v8__HandleT_v8__Function_t swig_types[28]
...
static SwigV8ReturnValue _wrap_Spi_write_word__SWIG_0(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  SWIGV8_HANDLESCOPE();
...
static SwigV8ReturnValue _wrap_Spi_write_word__SWIG_1(const SwigV8Arguments &args, V8ErrorHandler &SWIGV8_ErrorHandler)
{
  SWIGV8_HANDLESCOPE();
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Spi_write_word" "', argument " "2"" of type '" "uint16_t *""'"); 
  }
  arg2 = (uint16_t *)(argp2);
  ecode3 = SWIG_AsVal_int(args[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Spi_write_word" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  {
    try {
      result = (uint16_t *)(arg1)->write_word(arg2,arg3);
    } catch(const std::invalid_argument& e) {
      SWIG_exception(SWIG_ValueError, e.what());
    } catch(...) {
      SWIG_exception(SWIG_RuntimeError, "Unknown exception");
...
static SwigV8ReturnValue _wrap_Spi__wrap_Spi_write_word(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() == 1) {
    errorHandler.err.Clear();
#if (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_Spi_write_word__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
    _wrap_Spi_write_word__SWIG_0(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    }
#endif
  ...
  if(args.Length() == 2) {
    errorHandler.err.Clear();
#if (SWIG_V8_VERSION < 0x031903)
    jsresult = _wrap_Spi_write_word__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      SWIGV8_ESCAPE(jsresult);
    }
#else
    _wrap_Spi_write_word__SWIG_1(args, errorHandler);
    if(errorHandler.err.IsEmpty()) {
      return;
    }
#endif
  ...
  SWIG_exception_fail(SWIG_ERROR, "Illegal arguments for function write_word.");
...
static SwigV8ReturnValue _wrap_new_Uart(const SwigV8Arguments &args) {
  ...
  int ecode1 = 0 ;
  mraa::Uart *result;
  if(args.Length() != 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Uart.");
  ecode1 = SWIG_AsVal_int(args[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
SWIGV8_AddMemberFunction(_exports_Spi_class, "write_word", _wrap_Spi__wrap_Spi_write_word);
